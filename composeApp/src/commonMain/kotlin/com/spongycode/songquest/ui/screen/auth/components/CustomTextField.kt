...
import song_quest.composeapp.generated.resources.baseline_visibility_off_24
        ...
        OutlinedTextField(
            ...
            trailingIcon = if (isPasswordToggleDisplayed) {
                val icon: @Composable () -> Unit = {
                    Icon(
                        painter = if (isPasswordVisible.not()) painterResource(resource =  Res.drawable.baseline_visibility_24)
                        else painterResource(resource = Res.drawable.baseline_visibility_off_24),
